...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-gray-50">
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden bg-amber-700">
            <div className="flex flex-col space-y-2 p-4">
              <Link
                to="/pricing"
                className="px-6 py-3 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-200 text-center"
              >
                Pricing
              </Link>
              <Link
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto bg-white rounded-lg shadow-lg my-8">
