    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-gray-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
          Navigate complex Indian legal frameworks with confidence. Lex & Tech AI provides expert guidance on BNS, DPDP, POCSO, and more, powered by advanced AI technology trusted by legal professionals.
        </p>
