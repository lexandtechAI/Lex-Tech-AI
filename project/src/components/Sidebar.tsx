...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white transform transition-all duration-300 ease-in-out ${isOpen ? 'translate-x-0 w-80' : '-translate-x-full'} md:relative md:translate-x-0 ${isOpen ? 'md:w-80' : 'md:w-16'} flex flex-col`}
      >
